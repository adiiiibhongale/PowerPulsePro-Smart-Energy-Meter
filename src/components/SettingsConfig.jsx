...
.sc-account-save-row { margin-top:1.2rem; display:flex; justify-content:flex-start; }
.sc-account-save-row .sc-btn { width:auto; min-width:0; padding:.45rem 1.1rem; font-size:.78rem; border-radius:8px; background:var(--sc-primary); color:#fff; box-shadow:none; }
...
@media (max-width:700px){
  ...
  .sc-account-save-row .sc-btn { min-width:0; }
}
`;
  ...
  return (
    <div className="sc-container">
        ...
        {tab===0 && (
          <section className="sc-card" aria-label="Device Configuration">
            ...
            <div className="sc-btn-row">
              <button className="sc-btn sc-btn-primary sc-btn-compact">Apply Changes</button>
              <button className="sc-btn sc-btn-secondary sc-btn-compact">Reboot Device</button>
              <button className="sc-btn sc-btn-secondary sc-btn-compact">Reset to Saved</button>
            </div>
          </section>
        )}
        {tab===1 && (
              ...
              <form className="sc-account-form">
                <div>
                  ...
                  <div className="sc-account-profile-row">
                    <div className="sc-account-field"><label className="sc-label">Consumer Name</label><input className="sc-input" value="ATUL TUKARAM BHONGALE" readOnly /></div>
                    <div className="sc-account-field"><label className="sc-label">Email Address</label><input className="sc-input" value="atul.t@example.com" readOnly /></div>
                    <div className="sc-account-field"><label className="sc-label">Mobile Number</label><input className="sc-input" value="+91-987******1" readOnly /></div>
                  </div>
                </div>
                <div>
                  <div className="sc-account-section-title">Notification Preferences</div>
                  <div className="sc-account-notify-row">
                    <label className="sc-account-checkbox"><input type="checkbox" checked readOnly /> Receive Email Alerts</label>
                    <label className="sc-account-checkbox"><input type="checkbox" checked readOnly /> Receive SMS Alerts</label>
                  </div>
                </div>
                <div>
      ...
      <footer className="sc-footer" role="contentinfo">
        <div>Need help? Contact <a href="mailto:support@powerpulsepro.com" className="sc-footer-link">PowerPulsePro Support</a></div>
